...
_[Reading](https://clauswilke.com/dataviz/multi-panel-figures.html), [Recording](),  [Rmarkdown](https://github.com/krisrs1128/stat479_s22/blob/main/_posts/2022-02-06-week03-03/week03-03.Rmd)_
...
(p[["bar"]] + p[["scatter"]]) / p[["box"]] +
  ...
  plot_annotation(theme = theme(legend.position = "left"))
```
