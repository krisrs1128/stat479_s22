...
1. [Spatio-temporal T/F] Circle TRUE or FALSE for all statements below about
...
1. [Clustering vs. Topic Models]  Circle TRUE or FALSE for all statements below
...
1. [Network Vis T/F] Select all the true statements about network visualization.
    ...
    * TRUE or FALSE: The `treemap` and `circlepack` layouts in `ggraph` can be used to visually represent enclosure relationships between nodes in a graph.
    * TRUE or FALSE: The adjacency matrix visualization of a directed graph will generally be symmetric across the diagonal.
...
1. [Dimensionality Reduction Review]  This problem asks you to explain, in your
own words, a few conceptual and practical aspects for **one of the following**
...
1. [Polio conceptual] The polio dataset contains weekly counts of new polio
...
1. [Movies K-means] In this problem, we will see how a heatmap can visualize
user ratings across a collection of movies.
    ...
    b. In this visualization, how do you interpret sets of similar rows?
    Similar columns?
...
1. [UMAP vs. PCA] This problem asks you to compare and contrast dimensionality reduction using and
UMAP and PCA.
