...
[Kaggle Datasets](https://www.kaggle.com/datasets), or [Google Dataset
Search](https://datasetsearch.research.google.com/) that you think would be
interesting to visualize this semester. Give an example of a question or
comparison for which this data might be useful. You do not need to download the
dataset, but do provide a link, so we can use it to create future exercises.
