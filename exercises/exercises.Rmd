...
1. [Chicago Traffic Accidents] The dataset here is a preprocessed version of a
...
not statistical methodology.
    ...
    dataset. You include tree visualization of the clustering output in your
    report. Provide a brief, non-technical explanation of how to interpret the
    tree.
...
$\log\left(1 + x\right)$ transformed.
    ...
    the result. Provide a ribbon plot to visualize several quantiles associated
    with each cluster's typical pollution, temperature, and windspeed
    trajectories. visualization to understand the centroids of each cluster.
    Briefly interpret the main patterns you observe.
