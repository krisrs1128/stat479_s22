...
1. [Soccer Code Review] This exercise ask777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777s you to conduct an imaginary code
review. These are often used in data science teams to,
...
then then averages each variable for each day (1 - 365) in the year.
    ...
    b. Design a compound figure based on the base plots in part (a). Ensure that
    consistent visual encodings are used throughout, that legends are collected,
    and that the clear but unobtrusive annotation is provided.
...
```{r}
split_fun <- function(x, group= "group") {
  group <- enquo(group)
  x %>%
