...
[here](https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_slides/week10/exercises/living_wages_lookup.csv).
    ...
    principal components. Make sure to annotate cities with their names. Give an
    example of a city with a low living wage but high minimum wage (i.e., a state
    where it is not expensive to live, and where the minimum wage is above
    average).
