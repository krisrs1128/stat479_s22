...
were gathered by simulating a user's browsing through recommendations, after
...
consume energy. For example, the edge
    ...
    means that 289 KwH produced by wind power was sent to the country's electricity grid.
