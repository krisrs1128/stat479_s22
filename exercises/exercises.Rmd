...
variable (yearly salary in USD), using all potential predictors in the dataset.
    ...
    c. Show the analogous display without aggregating (i.e., `geom =
    "profiles"). What is the interpretation of each line in this plot? In what
    ways does it deepen your interpretation from part (b)?
